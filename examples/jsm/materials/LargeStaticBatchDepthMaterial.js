...
class LargeStaticBatchDepthMaterial extends ShaderMaterial {

	constructor() {
		super({
			name: 'LargeStaticBatchDepth',
			uniforms: {
				drawIdTexture: null,
		...
		this.shaderName = 'LargeStaticBatchDepth';
...
export { LargeStaticBatchDepthMaterial };
