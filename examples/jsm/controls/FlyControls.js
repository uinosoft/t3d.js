...
var FlyControls = function(object, domElement) {
	...
	this.dispose = function () {
		...
		this.domElement.removeEventListener('mouseup', _mouseup, { passive: false });
	...
	this.domElement.addEventListener('mousedown', _mousedown, { passive: false });
	this.domElement.addEventListener('mouseup', _mouseup, { passive: false });
